...
export default function Main() {
  ...
  <span className="flex animate- items-center gap-4">Hi there! I'm <WordRotate className="text-[#b02e2e]" words={["Priyansh Neel", "प्रियांश नील", "پریانش نیل"]} /></span>web developer,<br />product designer,<br />maker & future entrepreneur</h1>
